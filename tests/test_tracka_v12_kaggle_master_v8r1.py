...
SCIENCE_SHA = "f8aea6c2b481f8436653d4c6504f406948a98082"
CODE_ATTESTATION_SHA256 = "e3c38aa2de9db070200732e8b67463956476413ee2899c2db462e6bca02a3d7e"
LOCK_ATTESTATION_SHA256 = "1bc81be25b38cd7bf8490858c7d4931b811e993702210d2f856b56a96d7decbe"


class TrackAV12KaggleMasterV8R1Tests(unittest.TestCase):
    def test_v8r1_rebinds_all_inherited_science_authorities(self):
        ...
        self.assertEqual(v8.OPERATOR_SCHEMA_VERSION, "4.1")

    def test_packaged_exact_head_attestations_are_exact_and_current(self):
        code, lock = verified_attestation_paths()
        self.assertEqual(v8.sha256_file(code), CODE_ATTESTATION_SHA256)
        self.assertEqual(v8.sha256_file(lock), LOCK_ATTESTATION_SHA256)
        cp = json.loads(code.read_text(encoding="utf-8"))
        lp = json.loads(lock.read_text(encoding="utf-8"))
        for payload in (cp, lp):
            ...
            self.assertTrue(payload["github_actions"])
        ...
        self.assertEqual(
            cp["implementation_sha256"]["journal_extension/scripts/qualify_tracka_v12_profile_v122.py"],
            "2c3ebe31582db29adb9835e6c5bad797c9134f54d4075d43a597a083e253b4dc",
        )
    ...
    def test_direct_g1a_and_g2a_paths_have_no_compatibility_injection(self):
