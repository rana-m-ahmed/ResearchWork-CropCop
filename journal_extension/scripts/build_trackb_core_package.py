...
def main() -> int:
    ...
    cmd = [
        ...
        "--execution-lock", "repository/journal_extension/track_b_r07/TRACKB_R07_EXECUTION_LOCK_v3.json",
        "--code-attestation", "repository/journal_extension/track_b_r07/TRACKB_CODE_ATTESTATION_v3.json",
