...
def main() -> int:
    ...
    cmd = [
        ...
        "--downstream-authority", "repository/journal_extension/amendments/track_bc_r07_downstream_v1.json",
        "--execution-lock", "repository/journal_extension/track_b_r07/TRACKB_R07_EXECUTION_LOCK_v1.json",
