                ...
                writer.writerow(
                    {
                        ...
                        "published_n": result["source_audit"]["published_file_count"],
                        "decode_invalid_n": result["source_audit"]["decode_invalid_count"],
                        "n": metric["row_count"],
                        "seed": seed,
...
def main() -> int:
    ...
    for dataset_id in ("gvlid_grape", "irish_potato"):
        ...
        dataset_results[dataset_id] = {
            "scope": spec["scope"],
            "source_audit": leakage_audit["datasets"][dataset_id],
            "mapping": spec["mapping"],
